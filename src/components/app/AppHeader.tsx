...
export function AppHeader() {
  return (
    <header className="sticky top-0 z-30 border-b border-bakery-border/70 bg-bakery-cream/88 backdrop-blur-xl lg:hidden">
      <div className="mx-auto flex min-h-[4.7rem] max-w-[var(--sales-max-width)] items-center justify-between gap-3 px-4">
        <Link to="/" className="flex min-w-0 items-center gap-3" aria-label="Ir para venda">
